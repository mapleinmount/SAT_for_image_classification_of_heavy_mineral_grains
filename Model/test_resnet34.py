...
def main():
    ...
    set_dict = {'C' : "/deepo_data/GSP/heavy_minerals/data/ChangJiang/val",
                'P' : "/deepo_data/GSP/heavy_minerals/data/PengQu/val",
                'Y' : "/deepo_data/GSP/heavy_minerals/data/YaJiang/val"}
    val_domain_folders = []
