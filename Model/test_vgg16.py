...
def get_parser():
    ...
    parser.add_argument('--testset', type=str, help='test sets')
...
def main():
    ...
    set_dict = {'C' : "/deepo_data/GSP/heavy_minerals/data/Yangtze/val",
                'P' : "/deepo_data/GSP/heavy_minerals/data/PumQu/val",
                'Y' : "/deepo_data/GSP/heavy_minerals/data/YarlungZangbo/val"}
    val_domain_folders = []

    for set_ in args.testset:
        val_domain_folders.append(set_dict[set_])
